...
const getImportantDetailsForCommercial = (details: any) => {
  return {
    ...
    "Bina Tipi": details.buildingType || 'Belirtilmemiş',
...
// Commercial Feature Categories - CommercialDetails'den alınan aynı kategoriler
...
const FeatureCategories = ({ details }: { details: any }) => (
  <Grid container spacing={1}>
    {COMMERCIAL_FEATURE_CATEGORIES.map((category, index) => (
...
// Main Component
export default function StepSixCommercial({
