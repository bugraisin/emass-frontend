...
// Service Feature Categories - ServiceDetails'den alınan aynı kategoriler
...
const FeatureCategories = ({ details }: { details: any }) => (
  <Grid container spacing={1}>
    {SERVICE_FEATURE_CATEGORIES.map((category, index) => (
...
// Main Component
export default function StepSixService({
