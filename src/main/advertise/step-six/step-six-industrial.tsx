...
// Industrial Feature Categories - IndustrialDetails'den alınan aynı kategoriler
...
const FeatureCategories = ({ details }: { details: any }) => (
  <Grid container spacing={1}>
    {INDUSTRIAL_FEATURE_CATEGORIES.map((category, index) => (
...
// Main Component
export default function StepSixIndustrial({
