...
const getImportantDetailsForLand = (details: any) => {
  return {
    "Arsa Alanı (m²)": details.landArea || 'Belirtilmemiş',
    "İmar Durumu": details.zoningStatus || 'Belirtilmemiş',
    "Ada No": details.adaNo || 'Belirtilmemiş',
    "Parsel No": details.parcelNo || 'Belirtilmemiş',
    "Pafta No": details.paftaNo || 'Belirtilmemiş',
    "KAKS (Emsal)": details.kaks || 'Belirtilmemiş',
    "Gabari (m)": details.gabari || 'Belirtilmemiş',
    "Tapu Durumu": details.tapuStatus || 'Belirtilmemiş',
  };
};
...
// Land Feature Categories - LandDetails'den alınan aynı kategoriler
...
const FeatureCategories = ({ details }: { details: any }) => (
  <Grid container spacing={1}>
    {LAND_FEATURE_CATEGORIES.map((category, index) => (
...
// Main Component
export default function StepSixLand({
