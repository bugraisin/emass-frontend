...
export default forwardRef<any, IndustrialDetailsProps>(function IndustrialDetails({ selectedCategory }, ref) {
    const [anchorEl, setAnchorEl] = useState<HTMLElement | null>(null);
    const [popoverType, setPopoverType] = useState<'totalArea' | 'age' | 'ceilingHeight' | 'Altyapı & Enerji' | 'Üretim & İmalat' | 'Depolama & Lojistik' | 'Güvenlik & Sistem' | null>(null);
    ...
    const getIndustrialDetails = () => {
        ...
        console.log('End Details verisi alınıyor:', industrialData);
        return industrialData;
    };

    // Parent'a getDetails fonksiyonunu expose et
    useImperativeHandle(ref, () => ({
        getDetails: getIndustrialDetails
    }));
    ...
    const handlePopoverOpen = (event: React.MouseEvent<HTMLElement>, type: 'totalArea' | 'age' | 'ceilingHeight' | 'Altyapı & Enerji' | 'Üretim & İmalat' | 'Depolama & Lojistik' | 'Güvenlik & Sistem') => {
